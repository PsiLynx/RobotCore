...
public class FollowerConstants {
    ...
    private static double xMovement = 70.1558;
    private static double yMovement = 59.3844;
    ...
    // this is for curves
    public static double forwardZeroPowerAcceleration = -44.7551;

    // Acceleration of the drivetrain when power is cut in inches/second^2 (should be negative)
    // if not negative, then the robot thinks that its going to go faster under 0 power
    // this is for curves
    public static double lateralZeroPowerAcceleration = -72.4488;
