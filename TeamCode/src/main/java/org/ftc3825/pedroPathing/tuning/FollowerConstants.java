...
public class FollowerConstants {
    ...
    private static double xMovement = 75.7545;
    private static double yMovement = 50.3639;
    ...
    public static double translationalPIDFFeedForward = 0.07;
    ...
    public static double drivePIDFFeedForward = 0.05;
    ...
    public static double forwardZeroPowerAcceleration = -59.154;

    // Acceleration of the drivetrain when power is cut in inches/second^2 (should be negative)
    // if not negative, then the robot thinks that its going to go faster under 0 power
    public static double lateralZeroPowerAcceleration = -77.5637;
