...
import static org.firstinspires.ftc.teamcode.akit.LogTable.*;

import org.firstinspires.ftc.teamcode.akit.wpi.DataLogIterator;
import org.firstinspires.ftc.teamcode.akit.wpi.DataLogReader;
import org.firstinspires.ftc.teamcode.akit.wpi.DataLogRecord;
...
public class WPILOGReader implements LogReplaySource {
  ...
  public void start() {
    ...
    try {
      ...
      System.out.println("[AdvantageKit] Failed to open replay log file.");
    }

    // Check validity
    if (!reader.isValid()) {
      System.out.println("[AdvantageKit] The replay log is not a valid WPILOG" +
                      " file.");
      isValid = false;
